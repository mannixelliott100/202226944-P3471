...
.section {
    ...
    max-width: 1100px; /* content width limit */
...
.split {
    ...
    gap: 2%; /* relative gap avoids overflow */
}
.split.reverse { flex-direction: row-reverse; }

.visual-side, .text-side {
    flex: 1 1 49%; /* slightly less than half to accommodate gap */
    min-width: 300px; 
    box-sizing: border-box;
}
...
/* --- FULL WIDTH VISUAL --- */
.full-visual { width: 100%; padding: 0; margin: 40px 0; }
